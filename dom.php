...
//START ganon.php
function rex_str_get_dom($str, $return_root = true) {
    $a = new HTML_Parser_HTML5($str);
    return (($return_root) ? $a->root : $a);
}
function rex_file_get_dom($file, $return_root = true, $use_include_path = false, $context = null) {
    ...
    return (($f === false) ? false : rex_str_get_dom($f, $return_root));
}
function rex_dom_format(&$root, $options = array()) {
